(function () {
    ...
    MailMessageController.$inject = ['mail', '$scope', '$state', '$sce', 'tag', '$rootScope', '$auth', '$uibModal', 'contact', '$stateParams'];

    /* @ngInject */
    function MailMessageController(mail, $scope, $state, $sce, tag, $rootScope, $auth, $uibModal, contact, $stateParams) {
        var vm = this;
