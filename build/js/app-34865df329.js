...
$templateCache.put('app/components/inbox-message-list/inbox-message-list.html','<div class="inbox-message-list"><!--{{ vm.messages.data[0] }}--><inbox-message message="message" ng-repeat="message in vm.messages.data"></inbox-message></div>');
