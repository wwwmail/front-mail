...
(function () {
    ...
    core.run(["$rootScope", "$translate", "$timeout", "$stateParams", "lang", "config", "init", "CONFIG", "theme", "timezone", "$cookies", "$auth", function($rootScope, $translate, $timeout, $stateParams, lang, config, init, CONFIG, theme, timezone, $cookies, $auth) {
...
(function () {
    ...
    profile.$inject = ['CONFIG', '$resource', 'Upload', '$rootScope', '$auth', '$state', 'localStorageService', '$translate', 'notify'];

    function profile(CONFIG, $resource, Upload, $rootScope, $auth, $state, localStorageService, $translate, notify) {
        ...
        return [
            {
                state: 'mail.inbox',
                config: {
                    url: '/inbox?mbox&filter&tag_id&compose&search&sort&sortReverse&search_part&search_tag_id&search_start&search_end',
...
$templateCache.put('app/components/alert-popup/alert-popup.html','<div><div class="popup__close" ng-click="cancel()">\xD7</div><div class="tag-create__title">\u041E\u043F\u043B\u0430\u0442\u0430 \u0443\u0441\u043F\u0435\u0448\u043D\u043E \u043F\u0440\u043E\u0448\u043B\u0430!</div><div class="mrg--t15"><p>\u041E\u0436\u0438\u0434\u0430\u0439\u0442\u0435 \u0437\u0430\u0432\u0435\u0440\u0448\u0435\u043D\u0438\u044F..</p><div class="folder-create__btn mrg--t40"><button class="btn-y btn-y--border" type="button" ng-click="vm.close()">\u0425\u043E\u0440\u043E\u0448\u043E</button></div></div></div>');
...
$templateCache.put('app/components/contact-group-create/contact-group-create.html','<div class="popup"><div class="popup__header"><span class="">{{ \'CREATE_NEW_GROUP\' | translate }}</span></div><form name="contactGroupForm" ng-submit="vm.create(contactGroupForm)" novalidate><div class="popup__content pdd--t20 pdd--b20"><span class="mrg--t4 mrg--r10">{{ \'NAME\' | translate }}</span> <input class="input input--size_sm input--up-shadow width--size250" type="text" name="name" ng-model="vm.contactGroupForm.model.name" required><hr class="hr hr--bottom"></div><div class="popup__footer"><button class="btn btn--normal btn--size_l" type="button" ng-click="vm.close()">{{ \'CANCEL\' | translate }}</button> <button class="btn btn--yellow btn--size_l" type="submit">{{ \'CREATE_NEW_GROUP\' | translate }}</button></div></form></div><!--<div class="contact-group-create">--><!--<div class="contact-group-create__title">{{ \'CREATE_NEW_GROUP\' | translate }}</div>--><!--<div class="mrg&#45;&#45;t15">--><!--<form name="contactGroupForm" ng-submit="vm.create(contactGroupForm)" novalidate>--><!--<div class="contact-group-create__input mrg&#45;&#45;t15">--><!--<div class="mrg&#45;&#45;r10">--><!--<span class="font&#45;&#45;size13">{{ \'NAME\' | translate }}</span>--><!--</div>--><!--<div>--><!--<input class="input input&#45;&#45;size_s width&#45;&#45;inh input&#45;&#45;fc-sh-yellow"--><!--type="text"--><!--name="name"--><!--ng-model="vm.contactGroupForm.model.name"--><!--required/>--><!--</div>--><!--</div>--><!--<div class="contact-group-create__btn mrg&#45;&#45;t10">--><!--<button class="btn-y btn-y&#45;&#45;border" type="submit">{{ \'CREATE_GROUP\' | translate }}</button>--><!--<button class="btn-y btn-y&#45;&#45;border" type="button" ng-click="vm.close()">{{ \'CANCEL\' | translate }}</button>--><!--</div>--><!--</form>--><!--</div>--><!--</div>-->');
...
$templateCache.put('app/components/contact-group-edit/contact-group-edit.html','<div class="popup"><div class="popup__header"><span class="">{{ \'RENAME_GROUP\' | translate }}</span></div><form name="contactGroupForm" ng-submit="vm.create(contactGroupForm)" novalidate><div class="popup__content pdd--t20 pdd--b20"><span class="mrg--t4 mrg--r10">{{ \'NAME\' | translate }}</span> <input class="input input--size_sm input--up-shadow width--size250" type="text" name="name" ng-model="vm.contactGroupForm.model.name" required><hr class="hr hr--bottom"></div><div class="popup__footer"><button class="btn btn--normal btn--size_l" type="button" ng-click="vm.close()">{{ \'CANCEL\' | translate }}</button> <button class="btn btn--yellow btn--size_l" type="submit">{{ \'RENAME_GROUP\' | translate }}</button></div></form></div><!--<div class="contact-group-create">--><!--<div class="contact-group-create__title">{{ \'CREATE_NEW_GROUP\' | translate }}</div>--><!--<div class="mrg&#45;&#45;t15">--><!--<form name="contactGroupForm" ng-submit="vm.create(contactGroupForm)" novalidate>--><!--<div class="contact-group-create__input mrg&#45;&#45;t15">--><!--<div class="mrg&#45;&#45;r10">--><!--<span class="font&#45;&#45;size13">{{ \'NAME\' | translate }}</span>--><!--</div>--><!--<div>--><!--<input class="input input&#45;&#45;size_s width&#45;&#45;inh input&#45;&#45;fc-sh-yellow"--><!--type="text"--><!--name="name"--><!--ng-model="vm.contactGroupForm.model.name"--><!--required/>--><!--</div>--><!--</div>--><!--<div class="contact-group-create__btn mrg&#45;&#45;t10">--><!--<button class="btn-y btn-y&#45;&#45;border" type="submit">{{ \'RENAME_GROUP\' | translate }}</button>--><!--<button class="btn-y btn-y&#45;&#45;border" type="button" ng-click="vm.close()">{{ \'CANCEL\' | translate }}</button>--><!--</div>--><!--</form>--><!--</div>--><!--</div>-->');
...
$templateCache.put('app/components/contact-phones/contact-phones.html','<div><div class="edit-contact__add-data edit-contact__add-data--added" ng-repeat="phone in vm.phones"><span class="remove-data-input" ng-click="vm.remove(phone)"><i class="icon-delete"></i> </span><input class="input input--size_xs input--up-shadow width--size220" type="text" name="phone" ng-model="phone.value"></div><!-- \u0434\u043E\u0431\u0430\u0432\u0438\u0442\u044C \u0435\u0449\u0435 \u043D\u043E\u043C\u0435\u0440--><div class="edit-contact__add-data mrg--t5"><ng-form name="phoneForm" novalidate><span class="remove-data-input"><i class="icon-delete"></i> </span><input class="input input--size_xs input--up-shadow width--size220" type="text" name="phone" ng-model="vm.phoneForm.model.phone" ng-keyup="vm.add(phoneForm, $event.keyCode);" placeholder="{{ \'INPUT_PLACEHOLDER_ADD_PHONE\' | translate }}" required></ng-form></div></div>');
...
$templateCache.put('app/components/email-change/email-change.html','<div class="email-change"><div class="email-change__header"><span class="email-change__title">{{ \'CHANGE_MAIL\' | translate }}</span></div><div class="email-change__content"><form name="emailForm" ng-submit="vm.changeEmail(emailForm)" novalidate><div class="email-change__input"><div class="email-change__field-input"><div class="email-change__caption-input mrg--r10"><span class="font--size13">{{ \'NEW_MAIL\' | translate }}</span></div><div><input class="input input--size_s width--size220 input--fc-sh-yellow" type="email" name="email" ng-model="vm.emailForm.model.email" required></div></div></div><!--Server error--><div>{{ vm.error }}</div><div class="email-change__footer pos"><hr class="hr hr--top"><button class="btn btn--normal btn--size_l width--size168 mrg--r16" type="button" ng-click="vm.close()">{{ \'CANCEL\' | translate }}</button> <button class="btn btn--yellow btn--size_l width--size168" type="submit">{{ \'BTN_CHANGE\' | translate }}</button></div></form></div></div>');
...
$templateCache.put('app/components/folder-clear-confirm/folder-clear-confirm.html','<div class="popup"><div class="popup__header"><span class="">{{ \'EMPTY_THE_FOLDER\' | translate }}</span></div><div class="popup__content pdd--t20 pdd--b20">{{ \'EMPTY_THE_FOLDER_MSG\' | translate: {folder: (vm.folder.name | translate)} }}<hr class="hr hr--bottom"></div><div class="popup__footer"><button class="btn btn--normal btn--size_l float--left" type="button" ng-click="vm.cancel()">{{ \'CANCEL\' | translate }}</button> <button class="btn btn--yellow btn--size_l float--left" type="button" ng-click="vm.close()">{{ \'DELETE_WITH_LETTERS\' | translate }}</button></div></div><!--<div class="folder-create">--><!--<div class="folder-create__title">{{ \'EMPTY_THE_FOLDER\' | translate }}</div>--><!--<div class="mrg&#45;&#45;t10">--><!--{{ \'EMPTY_THE_FOLDER_MSG\' | translate: {folder: (vm.folder.name | translate)} }}--><!--</div>--><!--<div class="mrg&#45;&#45;t15">--><!--<div class="folder-create__btn">--><!--<button class="btn-y btn-y&#45;&#45;mail-fix btn&#45;&#45;yellow btn-y&#45;&#45;border"--><!--type="button"--><!--ng-click="vm.close()">--><!--{{ \'CLEAR\' | translate }}--><!--</button>--><!--<button class="btn-y btn-y&#45;&#45;mail-fix btn-y&#45;&#45;border"--><!--type="button"--><!--ng-click="vm.cancel()">--><!--{{ \'CANCEL\' | translate }}--><!--</button>--><!--</div>--><!--</div>--><!--</div>-->');
...
$templateCache.put('app/components/folder-create/folder-create.html','<div class="popup"><div class="popup__header"><span class="">{{ \'CREATED_FOLDER\' | translate }}</span></div><form name="form" ng-submit="vm.create(form)" novalidate><div class="popup__content pdd--t20 pdd--b20"><span class="mrg--r10">{{ \'NAME\' | translate }}</span> <input class="input input--size_sm input--up-shadow width--size250" ng-class="{\'input--error\': form.mboxnew.$invalid}" name="mboxnew" ng-model="vm.form.model.mboxnew" type="text" autofocus="true" ng-maxlength="20" required><hr class="hr hr--bottom"></div><div class="popup__footer"><button class="btn btn--normal btn--size_l float--left" type="button" ng-click="vm.close()">{{ \'CANCEL\' | translate }}</button> <button class="btn btn--yellow btn--size_l float--left" type="submit">{{ \'CREATE_FOLDER\' | translate }}</button></div></form></div><!--<div class="folder-create">--><!--<div class="tag-create__title">{{ \'CREATED_FOLDER\' | translate }}</div>--><!--<div class="mrg&#45;&#45;t15">--><!--<form name="form" ng-submit="vm.create(form)" novalidate>--><!--<div class="folder-create__input mrg&#45;&#45;t15">--><!--<div class="mrg&#45;&#45;r10">--><!--<span class="font&#45;&#45;size13">{{ \'NAME\' | translate }}</span>--><!--</div>--><!--<div>--><!--<input class="input input&#45;&#45;size_s width&#45;&#45;inh input&#45;&#45;fc-sh-yellow"--><!--ng-class="{\'input&#45;&#45;error\': form.mboxnew.$invalid}"--><!--name="mboxnew"--><!--ng-model="vm.form.model.mboxnew"--><!--type="text"--><!--autofocus="true"--><!--ng-maxlength="20"--><!--required>--><!--&lt;!&ndash;<a class="link link&#45;&#45;dotted link&#45;&#45;violet font&#45;&#45;size13" href="">\u0412\u043B\u043E\u0436\u0438\u0442\u044C \u0432 \u0434\u0440\u0443\u0433\u0443\u044E \u043F\u0430\u043F\u043A\u0443</a>&ndash;&gt;--><!--</div>--><!--</div>--><!--<div class="folder-create__btn mrg--t40">--><!--<button class="btn-y btn-y&#45;&#45;border" type="submit">{{ \'CREATE_FOLDER\' | translate }}</button>--><!--<button class="btn-y btn-y&#45;&#45;border" type="button" ng-click="vm.close()">{{ \'CANCEL\' | translate }}</button>--><!--</div>--><!--</form>--><!--</div>--><!--</div>-->');
...
$templateCache.put('app/components/folder-delete-confirm/folder-delete-confirm.html','<div class="popup"><div class="popup__header"><span class="">{{ \'DELETING_FOLDER\' | translate }}</span></div><div class="popup__content pdd--t20 pdd--b20">{{ \'DELETING_FOLDER_MSG\' | translate: {folder: (vm.folder.name | translate), messageCount: vm.folder.messagesCount} }}<hr class="hr hr--bottom"></div><div class="popup__footer"><button class="btn btn--normal btn--size_l float--left" type="button" ng-click="vm.cancel()">{{ \'CANCEL\' | translate }}</button> <button class="btn btn--yellow btn--size_l float--left" type="button" ng-click="vm.close()">{{ \'DELETE_WITH_LETTERS\' | translate }}</button></div></div><!--<div class="folder-create">--><!--<div class="folder-create__title">{{ \'DELETING_FOLDER\' | translate }}</div>--><!--<div class="mrg&#45;&#45;t10">--><!--{{ \'DELETING_FOLDER_MSG\' | translate: {folder: (vm.folder.name | translate), messageCount:--><!--vm.folder.messagesCount} }}--><!--</div>--><!--<div class="mrg&#45;&#45;t15">--><!--<div class="folder-create__btn">--><!--<button class="btn-y btn-y&#45;&#45;mail-fix btn&#45;&#45;yellow btn-y&#45;&#45;border"--><!--type="button"--><!--ng-click="vm.close()">--><!--{{ \'DELETE_WITH_LETTERS\' | translate }}--><!--</button>--><!--<button class="btn-y btn-y&#45;&#45;mail-fix btn-y&#45;&#45;border"--><!--type="button"--><!--ng-click="vm.cancel()">--><!--{{ \'CANCEL\' | translate }}--><!--</button>--><!--</div>--><!--</div>--><!--</div>-->');
...
$templateCache.put('app/components/folder-edit/folder-edit.html','<div class="popup"><div class="popup__header"><span class="">{{ \'RENAME_FOLDER\' | translate }}</span></div><form name="form" ng-submit="vm.update(form)" novalidate><div class="popup__content pdd--t20 pdd--b20"><span class="mrg--r10">{{ \'NAME\' | translate }}</span> <input class="input input--size_sm input--up-shadow width--size250" name="mboxnew" ng-model="vm.form.model.mboxnew" type="text" autofocus="true" ng-maxlength="20" required><hr class="hr hr--bottom"></div><div class="popup__footer"><button class="btn btn--normal btn--size_l" type="button" ng-click="vm.close()">{{ \'CANCEL\' | translate }}</button> <button class="btn btn--yellow btn--size_l" type="submit">{{ \'SAVE\' | translate }}</button></div></form></div><!--<div class="folder-create">--><!--<div class="tag-create__title">{{ \'RENAME_FOLDER\' | translate }}</div>--><!--<div class="mrg&#45;&#45;t15">--><!--<form name="form" ng-submit="vm.update(form)" novalidate>--><!--<div class="folder-create__input mrg&#45;&#45;t15">--><!--<div class="mrg&#45;&#45;r10">--><!--<span class="font&#45;&#45;size13">{{ \'NAME\' | translate }}</span>--><!--</div>--><!--<div>--><!--<input class="input input&#45;&#45;size_s width&#45;&#45;inh input&#45;&#45;fc-sh-yellow"--><!--name="mboxnew"--><!--ng-model="vm.form.model.mboxnew"--><!--type="text"--><!--required>--><!--&lt;!&ndash;<a class="link link&#45;&#45;dotted link&#45;&#45;violet font&#45;&#45;size13" href="">\u0412\u043B\u043E\u0436\u0438\u0442\u044C \u0432 \u0434\u0440\u0443\u0433\u0443\u044E \u043F\u0430\u043F\u043A\u0443</a>&ndash;&gt;--><!--</div>--><!--</div>--><!--<div class="folder-create__btn mrg--t40">--><!--<button class="btn-y btn-y&#45;&#45;border" type="submit">{{ \'SAVE\' | translate }}</button>--><!--<button class="btn-y btn-y&#45;&#45;border" type="button" ng-click="vm.close()">{{ \'CANCEL\' | translate }}</button>--><!--</div>--><!--</form>--><!--</div>--><!--</div>-->');
...
$templateCache.put('app/components/mail-sort-list/mail-sort-list.html','<div class="mail-sort-list"><div class="mail-sort-list__body"><a class="mail-sort-list__link" href ng-class="{\'mail-sort-list__link--active\': vm.$stateParams.sort == sort.value}" ng-repeat="sort in vm.sortList" ng-click="vm.onClickSort(sort)"><span class="mail-sort-list__name" ng-bind-html="sort.name | translate"></span> <img src="/images/sort/icon-sort-a-z.svg" ng-if="(vm.$stateParams.sort == sort.value && (vm.$stateParams.sortReverse == 0 || !vm.$stateParams.sortReverse) && (vm.$stateParams.sort !== \'date\' && vm.$stateParams.sort !== \'size\')) || (vm.$stateParams.sort == sort.value && vm.$stateParams.sortReverse == 1 && (vm.$stateParams.sort === \'date\' || vm.$stateParams.sort === \'size\' || vm.$stateParams.sort === \'unread\')) "> <img src="/images/sort/icon-sort-z-a.svg" ng-if="(vm.$stateParams.sort == sort.value && vm.$stateParams.sortReverse == 1 && (vm.$stateParams.sort !== \'date\' && vm.$stateParams.sort !== \'size\' && vm.$stateParams.sort !== \'unread\')) || (vm.$stateParams.sort == sort.value && (vm.$stateParams.sortReverse == 0 || !vm.$stateParams.sortReverse) && (vm.$stateParams.sort === \'date\' || vm.$stateParams.sort === \'size\'))"></a></div></div>');
$templateCache.put('app/components/message-alert-send/message-alert-send.html','<div class="message-alert-send" ng-show="vm.isShow"><div class="message-alert-send__container"><span class="message-alert-send__validate-icon icon-check-box-mark"></span> <span class="message-alert-send__notific" ng-bind-html="vm.message | translate:{folder: (vm.folder.name | translate), email: (vm.email | translate)} "></span> <button class="message-alert-send__close btn--not-style icon-close btn--main-mobile-color" type="button" ng-click="vm.close()"></button></div></div>');
$templateCache.put('app/components/message-avatar/message-avatar.html','<avatar-name class="{{ vm.classNames }}" ng-class="{\'avatar avatar--settings avatar--size30 avatar--second-style\': !vm.classNames}" name="vm.message.from" email="vm.message.fromAddress" ng-if="(!vm.message.avatar || !vm.isAvatarIsSuccess) && (vm.$state.params.mbox !== \'Sent\' && vm.$state.params.mbox !== \'Drafts\')" ui-sref="mail.inbox({search: vm.message.fromAddress, mbox: undefined, forceSearch: true})" ng-click="$event.stopPropagation();"></avatar-name><avatar-name class="{{ vm.classNames }}" ng-class="{\'avatar avatar--settings avatar--size30 avatar--second-style\': !vm.classNames}" name="vm.message.to[0].name" email="vm.message.to[0].address" ng-if="(!vm.message.avatar || !vm.isAvatarIsSuccess) && (!vm.user.profile.photo && (vm.$state.params.mbox === \'Sent\' || vm.$state.params.mbox === \'Drafts\'))" ui-sref="mail.inbox({search: vm.message.to[0].address, mbox: undefined, forceSearch: true})" ng-click="$event.stopPropagation();"></avatar-name><div class="{{ vm.classNames }}" ng-class="{\'avatar avatar--settings avatar--size30 avatar--second-style\': !vm.classNames}" ng-hide="!vm.isAvatarIsSuccess" ng-if="vm.message.avatar && !vm.isAvatarIsError"><img class="avatar__image" ng-src="{{ vm.message.avatar }}" image-load image-load-is-error="vm.isAvatarIsError" image-load-is-success="vm.isAvatarIsSuccess" image-load-is-loading="vm.isAvatarIsLoading"></div>');
...
$templateCache.put('app/components/message-save/message-save.html','<div class="popup"><div class="popup__header"><span class="">{{ \'SAVE_CHANGES\' | translate }}</span></div><!--<div class="popup__content just-content&#45;&#45;center pdd&#45;&#45;t20 pdd&#45;&#45;b20">--><!--<hr class="hr hr&#45;&#45;bottom">--><!--</div>--><div class="popup__footer"><button class="btn btn--yellow btn--size_l" type="button" ng-click="vm.close({save: true})">{{ \'SAVE_AND_GO\' | translate }}</button> <button class="btn btn--normal btn--size_l" type="button" ng-click="vm.close()">{{ \'NOT_SAVE\' | translate }}</button> <button class="btn btn--normal btn--size_l" type="button" ng-click="vm.cancel()">{{ \'CANCEL\' | translate }}</button></div></div>');
...
$templateCache.put('app/components/search-contact/search-contact.html','<div class="search-mail search-mail--open"><form name="searchForm" ng-submit="vm.search(searchForm)" novalidate><div class="search-mail__body"><div class="search-mail__group"><input class="input input--size_m input--fc-sh-yellow search-mail__input font--inh" placeholder="{{ \'SEARCH_CONTACTS\' | translate }}" type="text" name="search" ng-model="vm.searchForm.model.q" ng-change="vm.onSearchChange()"><div class="pos--rel height--all"><button class="btn-y btn-y--border search-mail__button font--inh height--all" type="submit">{{ \'SEARCH\' | translate }}</button></div></div></div></form></div>');
...
$templateCache.put('app/components/search-help/search-help.html','<div class="search-mail search-mail--open"><form name="searchForm" ng-submit="vm.search(searchForm)" novalidate><div class="search-mail__body"><div class="search-mail__group"><input class="input input--size_m input--fc-sh-yellow search-mail__input font--inh" placeholder="{{ \'INPUT_PLACEHOLDER_SEARCH_QUERY\' | translate }}" type="text" name="search" ng-model="vm.searchForm.model.q" ng-change="vm.onSearchChange()"><div class="pos--rel height--all"><button class="btn-y btn-y--border search-mail__button font--inh height--all" type="submit">{{ \'SEARCH\' | translate }}</button></div></div></div></form></div>');
$templateCache.put('app/components/settings-menu/settings-menu.html','<div class="settings-menu font-sizer--bigger-15"><div class="settings-menu__body"><a class="settings-menu__title font-sizer--bigger-18" ui-sref="settings.main" ng-click="vm.isSettingsMenuOpen = false">{{ \'ALL_SETTING\' | translate }}</a><div class="settings-menu__row mrg--t20"><div class="row row--size15 mrg--t20"><div class="col-xs-6 flex--inline align-items--cn"><span class="icon-account color--blue font--size18 width--aut"></span> <a class="settings-menu__link" ui-sref="settings.main" ng-click="vm.isSettingsMenuOpen = false">{{ \'MANAGE_ACCOUNT\' | translate }}</a></div><div class="col-xs-6 flex--inline align-items--cn"><span class="icon-processing-rules color--green font--size18 width--aut"></span> <a class="settings-menu__link" ui-sref="settings.rules" ng-click="vm.isSettingsMenuOpen = false">{{ \'PROCESSING_RULES\' | translate }}</a></div></div><div class="row row--size15 mrg--t20"><div class="col-xs-6 flex--inline align-items--cn"><span class="icon-to-a-folder color--yellow font--size18 width--aut"></span> <a class="settings-menu__link" ui-sref="settings.folders" ng-click="vm.isSettingsMenuOpen = false">{{ \'FOLDERS\' | translate }}</a></div><div class="col-xs-6 flex--inline align-items--cn"><span class="icon-markers color--yellow font--size18 width--aut"></span> <a class="settings-menu__link" ui-sref="settings.tags" ng-click="vm.isSettingsMenuOpen = false">{{ \'TAGS\' | translate }}</a></div></div><div class="row row--size15 mrg--t20"><div class="col-xs-6 flex--inline align-items--cn"><span class="icon-contact-settings color--green font--size18 width--aut"></span> <a class="settings-menu__link" ui-sref="settings.contacts" ng-click="vm.isSettingsMenuOpen = false">{{ \'SETTINGS_CONTACTS\' | translate }}</a></div><div class="col-xs-6 flex--inline align-items--cn"><span class="icon-collection-of-mail color--blue font--size18 width--aut"></span> <a class="settings-menu__link" ui-sref="settings.accounts" ng-click="vm.isSettingsMenuOpen = false">{{ \'COLLECT_MAIL_FROM_OTHER_BOX\' | translate }}</a></div></div><!--<div class="row row&#45;&#45;size15 mrg--t20">--><!--<div class="col-xs-6 flex&#45;&#45;inline align-items&#45;&#45;cn">--><!--<span class="icon-mail-space color&#45;&#45;green font--size18 width&#45;&#45;aut"></span>--><!--<a class="settings-menu__link" ui-sref="storage">--><!--\u0423\u0432\u0435\u043B\u0438\u0447\u0435\u043D\u0438\u0435 \u043E\u0431\u044C\u0435\u043C\u0430 \u043F\u043E\u0447\u0442\u044B--><!--</a>--><!--</div>--><!--</div>--></div></div></div>');
...
$templateCache.put('app/components/sign-create/sign-create.html','<div class="sign-create"><div class="sign-create__title">{{ \'ADD_SIGNATURE\' | translate }}</div><div class="mrg--t15"><form name="form" ng-submit="vm.create(form)" novalidate><div><div class="textarea textarea--normal width--inh" contenteditable="true" convert-new-lines="false" name="sign" ng-model="vm.form.model.sign"></div></div><div class="sign-create__btn mrg--t40"><button class="btn-y btn-y--border" type="submit">{{ \'SAVE\' | translate }}</button> <button class="btn-y btn-y--border" type="button" ng-click="vm.close()">{{ \'CANCEL\' | translate }}</button></div></form></div></div>');
...
$templateCache.put('app/components/tag-settings/tag-settings.html','<div class="tags-settings"><div class="tags-settings__title main-title-text">{{ \'TAGS\' | translate }}</div><div class="tags-settings__content"><div class="tags-settings__fields tags-settings__fields--auto-width"><div class="tags-settings__fields__title-block"><div class="tags-settings__item tags-settings__item--is-folders"><div class="tags-settings__title">{{ \'IMPORTANT\' | translate }}</div><!--<div class="tags-settings__values">10</div>--></div><div class="tags-settings__item tags-settings__item--is-folders"><div class="tags-settings__title">{{ \'UNREAD\' | translate }}</div><!--<div class="tags-settings__values">2</div>--></div></div><div class="tags-settings__item" ng-repeat="tag in vm.tags.items" ng-class="{\'tags-settings__item--active\': tag.isSelected}" ng-click="vm.select(tag)"><div class="label-ydx inbox-message__label mrg--r0" style="background: {{ tag.bgcolor }}">{{ tag.tag_name }}</div><!--<div class="tags-settings__values">1 / 2</div>--></div></div><div class="tags-settings__control"><div class="mrg--f-top"><!----> <button class="btn btn--normal width--size150 mrg--b4 btn--size_sm" ng-click="vm.openTagCreatePopup()">{{ \'NEW_LABEL\' | translate }}</button> <button class="btn btn--normal width--size150 mrg--b4 btn--size_sm" ng-click="vm.openTagEditPopup()" ng-disabled="!vm.selected">{{ \'CHANGE\' | translate }}</button> <button class="btn btn--normal width--size150 mrg--b4 btn--size_sm" ng-disabled="!vm.selected" ng-click="vm.destroy()">{{ \'DELETE\' | translate }}</button><!--<button class="btn btn&#45;&#45;normal width&#45;&#45;size150 mrg--b4 btn&#45;&#45;size_sm">\u0421\u043E\u0437\u0434\u0430\u0442\u044C \u043F\u0440\u0430\u0432\u0438\u043B\u043E</button>\n                <button class="btn btn&#45;&#45;normal width&#45;&#45;size150 mrg--b4 btn&#45;&#45;size_sm">\u041E\u0442\u043C\u0435\u043D\u0438\u0442\u044C</button>--></div><!--            <div class="mrg--f-bottom">\n                            <div class="radiobutton">\n                                <input class="radiobutton__input" type="radio" id="r1" name="rr"/>\n                                <label class="radiobutton__label" for="r1">\n                                            <span class="radiobutton__chek">\n                                                <span class="radiobutton__chek&#45;&#45;cheked"></span>\n                                            </span>\n                                    <span class="radiobutton__label__text">\u041F\u043E \u043A\u043E\u043B\u0438\u0447\u0435\u0441\u0442\u0432\u0443 \u043F\u0438\u0441\u0435\u043C</span></label>\n                            </div>\n\n                            <div class="radiobutton radiobutton&#45;&#45;size13">\n                                <input class="radiobutton__input" type="radio" id="r2" name="rr"/>\n                                <label class="radiobutton__label" for="r2">\n                                            <span class="radiobutton__chek">\n                                                <span class="radiobutton__chek&#45;&#45;cheked"></span>\n                                            </span>\n                                    <span class="radiobutton__label__text">\u041F\u043E \u0430\u043B\u0444\u0430\u0432\u0438\u0442\u0443</span>\n                                </label>\n                            </div>\n                        </div>--></div></div><!--<div class="form__field-item">--><!--</div>--></div>');
...
$templateCache.put('app/layout/aside-right/aside-right.html','<div class="aside-right"><div class="aside-right__container" ng-if="vm.isClosed === true"><div class="aside-right__header"></div><div class="banner-block banner-block--size160x600 banner-block--view-caption" banner-block-caption=" {{ \'BANNER_BLOCK_CAPTION\' | translate }}"><script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script><!-- My.mail.cz 160x600 --> <ins class="adsbygoogle" style="display:inline-block;width:160px;height:600px" data-ad-client="ca-pub-7169913763254428" data-ad-slot="9800681361"></ins><script>(adsbygoogle = window.adsbygoogle || []).push({});</script><!--<adsense ad-client="a-pub-7169913763254428"--><!--ad-slot="6851262006"--><!--inline-style="display:inline-block;width:160px;height:600px"--><!--ad-format="auto">--><!--</adsense>--></div><button class="aside-right__close-banner" type="button" ng-click="vm.closeBanner()"><span class="icon-close mrg--r10"></span> {{ \'CLOSE_BANNER\' | translate }}</button></div></div>');
$templateCache.put('app/layout/footer-auth/footer-auth.html','<div class="footer-auth"><div style="width: 80px"></div><!-- \u041A\u043E\u043F\u0438\u0440\u0430\u0439\u0442--><div class="footer-auth__copyright"><span class="">\xA9 2017 Mail Group, a.s.</span></div></div>');
$templateCache.put('app/layout/footer/footer.html','<div class="footer"><div class="footer__row"><div class="footer-left"><div class="footer__date-info" ng-if="vm.user.profile.last_login">{{ \'FOOTER_LAST_SING_IN\' | translate }}<to-date class="mrg--l3" date-unix="vm.user.profile.last_login"></to-date></div></div><div class="footer-right"><div class="footer-right__elemets">\xA9 2017, Mail.{{ vm.CONFIG.domainZone }}</div><div class="footer-right__elemets"><choice-language class="choice-language--main-footer"></choice-language></div></div></div></div>');
