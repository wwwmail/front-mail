...
(function () {
    ...
    core.config(["$httpProvider", function ($httpProvider) {
        ...
        $httpProvider
            .interceptors
            .push(["$q", "$rootScope", "$injector", function ($q, $rootScope, $injector) {
                return {
    ...
    core.config(["msdElasticConfig", function(msdElasticConfig) {
...
$templateCache.put('app/components/template-list/template-list-popover.html','<template-list on-save="vm.saveTemplate(result)" templates="vm.templates"></template-list>');
