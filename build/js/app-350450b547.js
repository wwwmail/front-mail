...
$templateCache.put('app/mail/mail.html','<section class="layout"><div class="layout__header"><header></header></div><div class="layout__inner" layout-height><!--\n        \u043E\u043F\u0438\u0441\u0430\u043D\u0438\u0435 \u0440\u0430\u0431\u043E\u0442\u044B\n\n        \u0435\u0441\u043B\u0438 \u0443\u043D\u0430\u0441 \u0448\u044B\u0440\u0438\u043D\u0430 \u043C\u0435\u043D\u044E < 180 px\n        \u0442\u043E \u043A \u043A\u043B\u0430\u0441\u0441\u0443 layout__menu  \u0434\u043E\u0431\u0430\u0432\u043B\u044F\u0435\u0442\u0441\u044F \u043A\u043B\u0430\u0441\u0441 is-menu-minimize\n\n        \u0435\u0441\u043B\u0438 \u0443\u043D\u0430\u0441 \u0448\u044B\u0440\u0438\u043D\u0430 \u043C\u0435\u043D\u044E >180 px \u0438 < 205px \u0442\u043E \u043C\u044B \u043A \u043A\u043B\u0430\u0441\u0443 layout__menu\n        \u0434\u043E\u0431\u0430\u0432\u043B\u044F\u0435\u043C \u043A\u043B\u0430\u0441\u0441 is-menu-middle\n\n        \u0435\u0441\u043B\u0438 \u0431\u043E\u043B\u044C\u0448\u0435 >180px \u0442\u043E \u0443\u0434\u0430\u043B\u044F\u0435\u043C \u043A\u043B\u0430\u0441\u0441 is-menu-minimize\n        \u0435\u0441\u043B\u0438 \u0431\u043E\u043B\u044C\u0448\u0435 >205px \u0442\u043E \u0443\u0434\u0430\u043B\u044F\u0435\u043C \u043A\u043B\u0430\u0441\u0441 is-menu-middle\n        --><div class="layout__left"><div class="layout__menu resize-menu" resize-menu><button class="layout__menu-switch btn--not-style" type="button" ng-click="close()"></button><menu-main folder="vm.folder"></menu-main></div></div><div class="layout__content"><ui-view class="height-flex--content"></ui-view><div class="layout__footer"><footer></footer></div></div></div></section>');
...
$templateCache.put('app/components/attach-upload/attach-upload.html','<div class="attach-upload"><a href="http://apimail.devogic.com/mail/{{ vm.message.model.number }}?&screen=true&mbox={{ vm.$state.params.mbox }}&part=attach&filename={{ attachment.fileName }}&token={{ vm.user.access_token }}&connection_id={{ vm.message.model.connection_id }}" target="_blank" ng-repeat="attachment in vm.attachmentsData"><div class="attach-upload__list"><div class="attach-upload__item">{{ attachment.fileName }}</div></div></a></div>');
