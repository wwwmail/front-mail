...
(function () {
    ...
    function googleBanner() {
        var directive = {
            ...
            restrict: 'AE',
            replace: true,
            template: '<ins class="adsbygoogle" style="display:block;width:160px;height:600px" data-ad-client="a-pub-7169913763254428" data-ad-slot="6851262006" data-ad-format="auto"></ins>'
        };
        return directive;
...
$templateCache.put('app/components/more-list/more-list-popover.html','<more-list messages="vm.messages" is-seen="vm.isSeen" trigger-seen="vm.triggerSeen()"></more-list>');
$templateCache.put('app/components/more-list/more-list.html','<div class="more-list"><div class="more-list__links"><a class="more-list__link visible--1300" href ng-click="vm.triggerSeen()"><span class="more-list__name" ng-if="vm.isSeen">{{ \'NOT_READ\' | translate }}</span> <span class="more-list__name" ng-if="!vm.isSeen">{{ \'READ\' | translate }}</span> </a><a class="more-list__link visible--1300" href ng-if="vm.messages.checked.length" uib-popover-template="\'app/components/tag-list/tag-list-popover.html\'" popover-class="popover--tag-list" popover-placement="bottom" popover-animation="true" popover-trigger="\'outsideClick\'"><span class="more-list__name">{{ \'LABEL\' | translate }}</span> </a><a class="more-list__link visible--1400" href ng-if="vm.messages.checked.length" uib-popover-template="\'app/components/folder-list/folder-list-popover.html\'" popover-class="popover--folder-list" popover-placement="bottom" popover-animation="true" popover-trigger="\'outsideClick\'"><span class="more-list__name">{{ \'IN_FOLDER\' | translate }}</span> </a><a class="more-list__link visible--1500" href ng-class="{\'inbox-header__link--disabled link--disabled\': !vm.messages.checked.length}" ng-click="vm.move({name: \'Archive\', caption: \'\u0410\u0440\u0445\u0438\u0432\'})"><span class="more-list__name">{{ \'ARCHIVED\' | translate }}</span> </a><a class="more-list__link" href ng-click="vm.print()"><span class="more-list__name">{{ \'PRINT\' | translate }}</span> </a><a class="more-list__link" ui-sref="settings.ruleAdd({\n                subject: vm.messages.checked[0].Subject,\n                email: vm.messages.checked[0].fromAddress\n        })"><span class="more-list__name">{{ \'CREATE_RULE_2\' | translate }}</span></a></div></div>');
