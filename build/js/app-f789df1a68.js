    ...
    function storageGraph($auth) {
        ...
        function link(scope, element, attrs) {
            ...
            $$('.storage__space-pie--my-space').forEach(function (pie) {
                var spaceDisk = (($auth.user.profile.usedQuota * 1000) / $auth.user.profile.freeQuota);
