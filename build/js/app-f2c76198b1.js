...
(function () {
    ...
    core.run(["$rootScope", "$translate", "$timeout", "lang", "config", "init", "CONFIG", "theme", "timezone", "$cookies", "$auth", function($rootScope, $translate, $timeout, lang, config, init, CONFIG, theme, timezone, $cookies, $auth) {
