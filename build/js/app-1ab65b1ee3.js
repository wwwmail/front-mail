...
$templateCache.put('app/components/search-mail/search-mail.html','<div class="search-mail" search-mail-open><form name="searchForm" ng-submit="vm.search(searchForm)" novalidate><div class="search-mail__body"><div class="search-mail__close" ng-if="isOpen"><button class="btn-y btn-y--white btn-y--close" ng-click="close()"><img class="btn-y__icon" src="/images/cancel.svg" alt="close search"></button></div><div class="search-mail__group"><input class="input input--size_m width--inh input--fc-sh-yellow search-mail__input" placeholder="\u0412\u0432\u0435\u0434\u0438\u0442\u0435 \u0437\u0430\u043F\u0440\u043E\u0441" type="text" name="search" ng-model="vm.searchForm.model.search" ng-click="open()"> <button class="btn-y btn-y--border search-mail__button" type="submit" ng-click="open()">\u041F\u043E\u0438\u0441\u043A</button></div></div></form></div>');
...
$templateCache.put('app/layout/menu-contacts/menu-contacts.html','<div class="menu-contacts"><!--\u0425\u0435\u0434\u0435\u0440--><div class="menu-contacts__head"><a class="menu-contacts__link is-active" href=""><span class="">\u0412\u0441\u0435</span> <span class="font__size12">10</span></a><hr class="hr menu-contacts__hr"></div><!--\u041E\u0441\u043D\u043E\u0432\u043D\u043E\u0439 \u043A\u043E\u043D\u0442\u0435\u043D\u0442--><div class="menu-contacts__content"><ul class="menu-main"><!----><li class="menu-main__item menu-main__item" ng-repeat="contactGroup in vm.contactGroup.items"><button class="btn-y pointer font__size15" type="button" ui-sref="contacts.main({groupId: contactGroup.id})"><svg class="menu-main__icon group-icon group-pall--c-1"><use xlink:href="#grid-square"></use></svg> {{ contactGroup.name }}</button></li><!----><li class="menu-main__item menu-main__item"><button class="btn-y pointer font__size15" type="button"><svg class="menu-main__icon group-icon group-pall--c-9"><use xlink:href="#grid-square"></use></svg> \u0414\u0440\u0443\u0437\u044C\u044F</button></li><!----><li class="menu-main__item menu-main__item"><button class="btn-y pointer font__size15" type="button"><svg class="menu-main__icon group-icon group-pall--c-8"><use xlink:href="#grid-square"></use></svg> \u0414\u0440\u0443\u0437\u044C\u044F</button></li><!----><li class="menu-main__item menu-main__item"><button class="btn-y pointer font__size15" type="button"><svg class="menu-main__icon group-icon group-pall--c-10"><use xlink:href="#grid-square"></use></svg> \u0414\u0440\u0443\u0437\u044C\u044F</button></li><!----><li class="menu-main__item menu-main__item"><button class="btn-y pointer font__size15" type="button"><svg class="menu-main__icon group-icon group-pall--c-19"><use xlink:href="#grid-square"></use></svg> \u0414\u0440\u0443\u0437\u044C\u044F</button></li><!----><li class="menu-main__item menu-main__item"><button class="btn-y pointer font__size15" type="button"><svg class="menu-main__icon group-icon group-pall--c-2"><use xlink:href="#grid-square"></use></svg> \u0414\u0440\u0443\u0437\u044C\u044F</button></li><!----><li class="menu-main__item menu-main__item"><button class="btn-y pointer font__size15" type="button"><svg class="menu-main__icon group-icon group-pall--c-2"><use xlink:href="#grid-square"></use></svg> \u0420\u043E\u0434\u043D\u044B\u0435</button></li><!----><li class="menu-main__item menu-main__item"><button class="btn-y pointer font__size15" type="button"><svg class="menu-main__icon group-icon group-pall--c-16"><use xlink:href="#grid-square"></use></svg> \u041A\u043E\u043B\u0435\u0433\u044B \u043F\u043E \u0440\u0430\u0431\u043E\u0442\u0435</button></li><!----><li class="menu-main__item menu-main__item"><button class="btn-y pointer font__size15" type="button"><svg class="menu-main__icon group-icon group-pall--c-12"><use xlink:href="#grid-square"></use></svg> \u0412\u0430\u0436\u043D\u044B\u0439 \u043F\u0440\u043E\u0435\u043A \u043A\u0438\u0435\u0432</button></li><!----><li class="menu-main__item menu-main__item"><button class="btn-y pointer font__size15" type="button"><svg class="menu-main__icon group-icon group-pall--c-6"><use xlink:href="#grid-square"></use></svg> \u0417\u0430\u0431\u043B\u043E\u043A\u0438\u0440\u043E\u0432\u0430\u043D\u043D\u044B\u0435</button></li></ul><div class="group-setup"><div class="group-setup__row"><a class="group-setup__link">\u0421\u043E\u0437\u0434\u0430\u0442\u044C \u0433\u0440\u0443\u043F\u043F\u0443 </a><a class="group-setup__link" ui-sref="settings.folders">\u043D\u0430\u0441\u0442\u0440\u043E\u0438\u0442\u044C...</a></div><hr class="hr"></div></div><!-- \u0424\u0443\u0442\u0435\u0440--><div class="menu-main-contacts__footer"></div></div>');
