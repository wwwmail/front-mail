...
(function () {
    ...
    appRun.$inject = ["routerHelper", "$http", "$rootScope", "$translate", "theme", "$timeout", "$cookies", "$auth", "timezone"];
    angular
        .module('app.core')
        .run(appRun);
...
$templateCache.put('app/components/info-sender-menu/info-sender-menu.html','<div class="info-sender-menu"><div class="info-sender-menu__header" id="info-sender-to">{{ vm.to.name || vm.to.address || vm.to.fullAddress || vm.to }}</div><div class="flex flex--colum"><button class="info-sender-menu__button" type="button" ng-click="vm.openComposePopup(); vm.close();">\u041D\u0430\u043F\u0438\u0441\u0430\u0442\u044C \u043F\u0438\u0441\u043B\u044C\u043C\u043E</button> <button class="info-sender-menu__button" type="button" ng-click="vm.close()" ngclipboard data-clipboard-target="#info-sender-to">\u0421\u043A\u043E\u043F\u0438\u0440\u043E\u0432\u0430\u0442\u044C \u0430\u0434\u0440\u0435\u0441</button></div></div>');
